...
public class Principal {
    private static final int noCuenta = 0;
    private static final int cuentaNormal = 1;
    private static final int cuentaPremium = 2;

    private static int tipoCuenta = noCuenta;
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    // Si la opción 2 es 1
                    if (opcionsub == 1) {
                        crearCuenta(cuentaNormal);
                    }
                    // Si la opción 2 es 2
                    else if (opcionsub == 2) {
                        crearCuenta(cuentaPremium);
                    }
                    // Si la opción es 0
                    else if (opcionsub == 0) {
    ...
    private static void retirarDinero() {
        ...
        if (cantidad > 0) {
            ...
            if (tipoCuenta == cuentaNormal && saldoCuenta < cantidad) {
                // Mostrar mensaje de error
